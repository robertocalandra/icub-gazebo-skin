 ...
 *
 */
public class GenerateXMLeftLegUpper{
	public static void main(String[] args) throws Exception {
		...
		// make left-arm model
		BufferedReader br = new BufferedReader(new FileReader("positions/leftLeg_upper_skin.txt"));
		...
		xout.output(icub_skin, new FileWriter("skin_left_upperleg.sdf"));
	}
