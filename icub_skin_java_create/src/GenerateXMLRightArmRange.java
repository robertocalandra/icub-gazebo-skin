 ...
 *
 */
public class GenerateXMLRightArmRange {
	public static void main(String[] args) throws Exception {
		...
		// make left-arm model
		BufferedReader br = new BufferedReader(new FileReader("positions/right_forearm_mesh.txt"));
		...
		xout.output(icub_skin, new FileWriter("skin_right_forearm.sdf"));
	}
