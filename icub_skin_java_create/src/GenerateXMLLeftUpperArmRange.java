 ...
 *
 */
public class GenerateXMLLeftUpperArmRange {
	public static void main(String[] args) throws Exception {
		...
		// make left-arm model
		BufferedReader br = new BufferedReader(new FileReader("positions/left_arm_mesh.txt"));
		...
		xout.output(icub_skin, new FileWriter("skin_left_arm.sdf"));
	}
